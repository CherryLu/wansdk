package com.wan.callring.ui.widget.banner;
...
import com.wan.callring.ui.widget.banner.listener.OnBannerClickListener;
import com.wan.callring.ui.widget.banner.listener.OnBannerListener;
import com.wan.callring.ui.widget.banner.loader.ImageLoaderInterface;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner setTitleBackground(int color){
