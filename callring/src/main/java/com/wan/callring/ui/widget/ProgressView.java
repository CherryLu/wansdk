...
public class ProgressView extends View {
	...
	private void init() {
		...
		setBackgroundColor(getResources().getColor(com.mabeijianxi.smallvideorecord2.R.color.camera_bg));
		...
		mPausePaint.setColor(getResources().getColor(
				com.mabeijianxi.smallvideorecord2.R.color.camera_progress_split));
		mPausePaint.setStyle(Paint.Style.FILL);

		mRemovePaint.setColor(getResources().getColor(
				com.mabeijianxi.smallvideorecord2.R.color.camera_progress_delete));
		mRemovePaint.setStyle(Paint.Style.FILL);

		mThreePaint.setColor(getResources().getColor(
				com.mabeijianxi.smallvideorecord2.R.color.camera_progress_three));
		mThreePaint.setStyle(Paint.Style.FILL);

		mOverflowPaint.setColor(getResources().getColor(
				com.mabeijianxi.smallvideorecord2.R.color.camera_progress_overflow));
