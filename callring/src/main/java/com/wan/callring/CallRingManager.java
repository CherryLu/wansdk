...
public class CallRingManager {
    ...
    private   static CallRingManager callRingManager;

    public static CallRingManager getInstance(Context context){

        synchronized (CallRingManager.class){
            if (callRingManager==null){
                callRingManager = new CallRingManager(context);
            }

            return callRingManager;
        }
    ...
    private void initImageLoader(){
        ...
        config = new ImageLoaderConfiguration.Builder(context.getApplicationContext())// 开始构建 ,图片加载配置
